...
| <img src=(https://github.com/user-attachments/assets/515aa72d-832b-45ba-b2f8-d1cfcb9ad44d) height=300 width="300" /> | <img src=(https://github.com/user-attachments/assets/515aa72d-832b-45ba-b2f8-d1cfcb9ad44d) height=300 width="300" /> | 서버(Java)에서 MQTT 메시지를 수신 후, `parking_space` 및 `parking_log` 테이블에 입·출차 기록 저장.<br>관리자는 콘솔 메뉴에서 전체 주차 현황 및 차량 로그를 확인할 수 있다. |
